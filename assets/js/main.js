...
<body>
            ...
            <div class="form-container">
                ...
                <form id="addQuestionForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="questionText" class="form-control" rows="3" required placeholder="Tulis pertanyaan disini"></textarea>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group option-group">
                            <label for="optionA">Opsi A:</label>
                            <input type="text" id="optionA" class="form-control" required placeholder="Jawaban A">
                        </div>
                        <div class="form-group option-group">
                            <label for="optionB">Opsi B:</label>
                            <input type="text" id="optionB" class="form-control" required placeholder="Jawaban B">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group option-group">
                            ...
                            <input type="text" id="optionC" class="form-control" placeholder="Jawaban C (opsional)">
                        </div>
                        <div class="form-group option-group">
                            <label for="optionD">Opsi D:</label>
                            <input type="text" id="optionD" class="form-control" placeholder="Jawaban D (opsional)">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="explanation" class="form-control" rows="3" placeholder="Penjelasan mengapa jawaban tersebut benar"></textarea>
                    </div>
    ...
    <script>
        ...
        document.getElementById('addQuestionForm').addEventListener('submit', function(e) {
            ...
            // Validate
            if (!question.text || question.options.length < 2 || !question.correctAnswer || !question.subject) {
                alert('Pertanyaan, minimal 2 opsi, jawaban benar, dan subjek harus diisi');
                return;
            }
        ...
        function loadQuestionsTable() {
            ...
            const sampleQuestions = [
                { id: 1, text: 'Berapa jumlah Rukun Iman?', subject: 'agama', level: 'sd', category: 'pelajar' },
                { id: 2, text: 'Pancasila sebagai dasar negara tercantum dalam...', subject: 'ppkn', level: 'smp', category: 'pelajar' },
                { id: 3, text: 'Jika x + 5 = 10, maka nilai x adalah?', subject: 'matematika', level: 'sma', category: 'pelajar' },
                { id: 4, text: 'Tahun berapa Indonesia merdeka?', subject: 'sejarah', level: '', category: 'umum' }
            ];
            ...
            sampleQuestions.forEach((q, i) => {
                ...
                tr.innerHTML = `
                    ...
                    <td>${q.level ? q.level.toUpperCase() : 'UMUM'}</td>
                    <td>
        ...
        window.editQuestion = function(id) {
            ...
            // In real implementation, would load question data into form
        };
